/* 
 * made by GroundZero 2017-04-07
 *
 * first of all make account and recieve api key from
 * 'http://openweathermap.org' to use this code 
 * 
 */
...
get_weather();
window.setInterval(get_weather, 10000);	// check weather every 10 seconds
										// 6 times/min < 60 times/min( to use API for free )
